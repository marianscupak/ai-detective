...
const ProfilePage = () => {
	return (
		<div className="text-foreground flex h-full flex-col gap-6 p-2 md:flex-row md:gap-4 md:px-24 md:py-6">
			<div className="flex w-full shrink-0 flex-col gap-6 md:h-full md:w-32 md:gap-4 lg:w-40 xl:w-48">
				<ProfileInfo />
				<UserAchievements />
			</div>
			<div className="bg-card flex w-full flex-col gap-3 rounded-xl border p-3 shadow-sm">
