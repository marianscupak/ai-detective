...
const InvestigationCard = ({
	...
	<li className="flex h-fit min-h-28 w-full shrink-0 flex-col justify-between gap-2 rounded-lg border bg-muted p-2 shadow not-only:w-9/10 md:min-h-24 md:w-full md:not-only:w-full lg:h-20 lg:min-h-auto lg:flex-row lg:gap-0">
		<div className="flex flex-col justify-between md:gap-1 lg:gap-0">
			...
			<div className="flex flex-col text-sm text-foreground md:gap-1 md:text-xs lg:gap-0">
				{variant === 'completed' ? (
					<>
						<div>
